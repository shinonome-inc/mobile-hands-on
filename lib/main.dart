...
// ツイートのフッターに表示するアイコンと数字のUIコンポーネント
...
// ツイートのフッター（リプライ数、リツイート数、いいね数、共有アイコン）
...
// ツイート（画像、ヘッダー、ツイート本文、フッターを表示）のUIコンポーネント
